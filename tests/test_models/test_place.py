...
class TestPlace(unittest.TestCase):
    ...
    def setUpClass(cls):
        """set up for test"""
        cls.place = Place()
        cls.place.city_id = "1937-wydad"
        cls.place.user_id = "2005-winners"
        cls.place.name = "Curva Nord"
        cls.place.description = "Frimija"
        cls.place.number_rooms = 10
        cls.place.number_bathrooms = 2
        cls.place.max_guest = 10
        cls.place.price_by_night = 100
        cls.place.latitude = 37.7749
        cls.place.longitude = -122.4194
        cls.place.amenity_ids = ["2020-corona"]
